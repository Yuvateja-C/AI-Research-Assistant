      ...
      <div className="flex-1 flex flex-col min-w-0 relative bg-white">
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-8 pt-24 pb-48 scroll-smooth">
          <div className="max-w-3xl mx-auto flex flex-col gap-8">
            ...
            {/* Summary Report Card */}
            {summary && (
              <div className="mt-4 p-6 or pt-8 rounded-2xl border shadow-lg bg-white relative overflow-hidden animate-in slide-in-from-bottom-4 duration-500" style={{ borderColor: theme.border }}>
